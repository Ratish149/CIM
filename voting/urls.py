...
urlpatterns = [
    ...
    path(
        ...
        VotingCreateView.as_view(),
        name="vote-create",
    ),
    path("top-questions/", TopQuestionView.as_view(), name="top-questions"),
    path(
        "running-session/questions/",
        QuestionsByRunningSessionView.as_view(),
    ...
    path(
        ...
        name="running-session-list-create",
    ),
    path(
        "running-sessions/<int:pk>/",
        RunningSessionRetrieveUpdateDestroyView.as_view(),
        name="running-session-retrieve-update-destroy",
    ),
    path(
        "running-session/<int:session_id>/",
        RunningSessionRetrieveUpdateDestroyView.as_view(),
        name="update-running-session",
    ),
    path(
        "running-session/toggle-questions/",
        UpdateSessionAcceptingQuestionsView.as_view(),
        name="toggle_accepting_questions",
    ),
]
