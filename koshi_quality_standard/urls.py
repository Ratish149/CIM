...
from .views import RequirementListView,CalculatePointsView,RequirementQuestionBulkUploadView,ResponseDetailView
...
urlpatterns = [
    ...
    path('responses/<int:id>/', ResponseDetailView.as_view(), name='response-detail'),
